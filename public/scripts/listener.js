...
var np2 = _interopDefault(require('next-pow-2'));
...
},{"fft.js":59,"next-pow-2":60}],62:[function(require,module,exports){
"use strict";
...
function pitchToNote(pitch) {
  ...
  let steps = {
    above: 0,
    below: 0 // step through scales to find nearest notes
  ...
  let n = undefined; // figure out which note is closer, and remember how many steps away it is
  ...
  let tuning = ""; // see how out of tune we are
...
},{"core-js/modules/es6.symbol":56,"core-js/modules/es7.symbol.async-iterator":57,"core-js/modules/web.dom.iterable":58,"pitchy":61}]},{},[62]);
